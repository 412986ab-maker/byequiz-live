...
class AuthManager {
  ...
  initDefaultUsers() {
    // Check if predefined ADMIN_PASSWORD_HASH is set, otherwise hash ADMIN_PASSWORD or fallback
    const adminPasswordHash = process.env.ADMIN_PASSWORD_HASH || hashPassword(process.env.ADMIN_PASSWORD || 'admin1234');
