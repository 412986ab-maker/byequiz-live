...
class TikTokConnector {
  constructor() {
    ...
    // Reconnection & Exponential Backoff Settings
  ...
  async connect(username = this.username) {
    ...
    try {
      // Dynamic import to prevent hard crashes if package missing in sandbox
      ...
      const signApiKey = process.env.SIGN_API_KEY || undefined;
